...
if __name__ == '__main__':
    ...
    parser.add_argument('--descriptor_types', nargs='+', type=str, help='Descriptor types (list)', default=['Tortuosity','VolumeFractions3D','Percolation'], choices=descriptor_choices)

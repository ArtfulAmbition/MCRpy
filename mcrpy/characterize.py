...
if __name__ == '__main__':
    ...
    parser.add_argument('--microstructure_filenames', nargs='+', type=str, help='File or files of MS to characterize', default=['/home/sobczyk/Dokumente/MCRpy/example_microstructures/BlockingLayer_X_20x20x20.npy'])
    ...
    parser.add_argument('--slice_mode', type=str, help='Average, sample slices or no_slicing (full 3D)?', default='no_slicing')
    ...
    # parser.set_defaults(directions_list=[0, 1,2])

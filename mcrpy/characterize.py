...
if __name__ == '__main__':
    ...
    parser.add_argument('--microstructure_filenames', nargs='+', type=str, help='File or files of MS to characterize', default=['/home/sobczyk/Dokumente/MCRpy/example_microstructures/BlockingLayer_X_2D_32x32.npy'])
    parser.add_argument('--data_folder', type=str, help='Results folder. If None, default with timestamp.', default='results')
    parser.add_argument('--descriptor_types', nargs='+', type=str, help='Descriptor types (list)', default=['VolumeFractions3D','Percolation'], choices=descriptor_choices)
    ...
    parser.add_argument('--slice_mode', type=str, help='Average, sample slices or no_slicing (full 3D)?', default='average')
    ...
    parser.add_argument('--directions', dest='directions_list', nargs='+', type=int, help='List of directions as 0-based indices (0=x, 1=y, 2=z). Example: --directions 0 1 2')
    parser.set_defaults(directions_list=[0, 1])
    ...
    parser.set_defaults(use_multigrid_descriptor=False)

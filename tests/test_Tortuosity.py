...
class TestTortuosity(unittest.TestCase):
    def setUp(self):
        ...
        ms = np.random.randint(0,high=2,size=(20, 20, 20))
        ms = ms.astype(int)
        self.microstructures['Random_20x20x20'] = ms
        np.save('/home/sobczyk/Dokumente/MCRpy/example_microstructures/Random_20x20x20.npy', self.microstructures['Random_20x20x20'])
        ...
        ms[3,3,3] = 0
        ms = ms.astype(int)
        self.microstructures['Diag_4x4x4'] = ms
        np.save('/home/sobczyk/Dokumente/MCRpy/example_microstructures/Diag_4x4x4.npy', self.microstructures['Diag_4x4x4'])
